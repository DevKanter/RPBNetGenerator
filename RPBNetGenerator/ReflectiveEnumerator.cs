...
namespace RPBNetGenerator
{
    ...
    {
        private static readonly List<INamedTypeSymbol> _symbols = new List<INamedTypeSymbol>();
        ...
        private static void _getAllSymbols(INamespaceSymbol namespaceSymbol)
        {
            ...
            foreach (var namespaceMember in namespaceSymbol.GetNamespaceMembers()) _getAllSymbols(namespaceMember);
        }
    }
}